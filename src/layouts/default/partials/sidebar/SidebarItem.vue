<template>
  <div>
    ...
    >
      ...
      <div
        v-if="link.hasChildren"
        :class="{ '!tw-max-h-[1000px] mb-2 mt-n3': isActive }"
        class="tw-max-h-0 tw-w-auto mx-3 tw-overflow-hidden tw-duration-300"
      >
            ...
            >
              <div class="tw-h-full py-2">
                <v-icon
                  ...
                  class="mr-2"
                  :color="
                    isSublinkActive(child) ? 'primary-color' : 'secondary-color'
                  "
                  :icon="
                    isSublinkActive(child)
                ...
                <span
                  class="tw-text-sm"
                  :class="{ 'text-primary-color': isSublinkActive(child) }"
                  >{{ child.title }}</span
                >
              </div>
            </v-list-item>
