...
export const confirmations = [
    ...
    { id: 1, value: 'day-one-call-one' , name: 'No reply 1 / day1', text: 'tw-text-rose-500', bg: 'tw-bg-rose-200/10', ring: 'tw-ring-rose-200' },
    { id: 2, value: 'day-one-call-two' , name: 'No reply 2 / day1', text: 'tw-text-rose-500', bg: 'tw-bg-rose-400/10', ring: 'tw-ring-rose-300' },
    { id: 3, value: 'day-one-call-three' , name: 'No reply 3 / day1', text: 'tw-text-rose-500', bg: 'tw-bg-rose-600/10', ring: 'tw-ring-rose-400' },
    { id: 4, value: 'day-two-call-one' , name: 'No reply 1 / day2', text: 'tw-text-indigo-500', bg: 'tw-bg-indigo-200/10', ring: 'tw-ring-indigo-200' },
    { id: 5, value: 'day-two-call-two' , name: 'No reply 2 / day2', text: 'tw-text-indigo-500', bg: 'tw-bg-indigo-400/10', ring: 'tw-ring-indigo-300' },
    { id: 6, value: 'day-two-call-three' , name: 'No reply 3 / day2', text: 'tw-text-indigo-500', bg: 'tw-bg-indigo-600/10', ring: 'tw-ring-indigo-400' },
    { id: 7, value: 'day-three-call-one' , name: 'No reply 1 / day3', text: 'tw-text-blue-500', bg: 'tw-bg-blue-200/10', ring: 'tw-ring-blue-200' },
    { id: 8, value: 'day-three-call-two' , name: 'No reply 2 / day3', text: 'tw-text-blue-500', bg: 'tw-bg-blue-400/10', ring: 'tw-ring-blue-300' },
    { id: 9, value: 'day-three-call-three' , name: 'No reply 3 / day3', text: 'tw-text-blue-500', bg: 'tw-bg-blue-600/10', ring: 'tw-ring-blue-400' },
    { id: 10, value: 'reporter' , name: 'Reported', text: 'tw-text-teal-500', bg: 'tw-bg-teal-500/10', ring: 'tw-ring-teal-300' },
    { id: 11, value: 'annuler' , name: 'Canceled', text: 'tw-text-red-500', bg: 'tw-bg-red-500/10', ring: 'tw-ring-red-300' },
...
export const deliveryStatus = [
    ...
    { id: 1, value:'dispatch', name: 'Dispatched', text: 'tw-text-yellow-500', bg: 'tw-bg-yellow-500/10', ring: 'tw-ring-yellow-300' },
    { id: 2, value: 'expidier' , name: 'Shipped', text: 'tw-text-fuchsia-500', bg: 'tw-bg-fuchsia-500/10', ring: 'tw-ring-fuchsia-300' },

    { id: 3, value:'livrer', name: 'Delivered', text: 'tw-text-green-500', bg: 'tw-bg-green-500/10', ring: 'tw-ring-green-300' },
    { id: 4, value:'reporter', name: 'Reported', text: 'tw-text-orange-500', bg: 'tw-bg-orange-500/10', ring: 'tw-ring-orange-300' },
    
    { id: 5, value:'refuser', name: 'Refused', text: 'tw-text-pink-500', bg: 'tw-bg-pink-500/10', ring: 'tw-ring-pink-300' },
    { id: 6, value:'annuler', name: 'Canceled', text: 'tw-text-red-500', bg: 'tw-bg-red-500/10', ring: 'tw-ring-red-300' },
    // { id: 8, value:'hors-zone', name: 'Hors zone', text: 'tw-text-blue-500', bg: 'tw-bg-blue-500/10', ring: 'tw-ring-blue-300' },
    { id: 9, value:'pas-de-reponse', name: 'No Answer', text: 'tw-text-yellow-500', bg: 'tw-bg-yellow-500/10', ring: 'tw-ring-yellow-300' },
