...
export const confirmations = [
    ...
    { id: 1, value: 'day-one-call-one' , name: 'No reply 1', text: 'tw-text-rose-500', textLight: 'tw-text-rose-700', bg: 'tw-bg-rose-200/10', bgLight: 'tw-bg-rose-100', ring: 'tw-ring-rose-200' },
    { id: 2, value: 'day-one-call-two' , name: 'No reply 2', text: 'tw-text-rose-500', textLight: 'tw-text-rose-800', bg: 'tw-bg-rose-400/10', bgLight: 'tw-bg-rose-100', ring: 'tw-ring-rose-300' },
    { id: 3, value: 'day-one-call-three' , name: 'No reply 3', text: 'tw-text-rose-500', textLight: 'tw-text-rose-900', bg: 'tw-bg-rose-600/10', bgLight: 'tw-bg-rose-100', ring: 'tw-ring-rose-400' },
    { id: 4, value: 'day-two-call-one' , name: 'No reply 4', text: 'tw-text-indigo-500', textLight: 'tw-text-indigo-700', bg: 'tw-bg-indigo-200/10', bgLight: 'tw-bg-indigo-100', ring: 'tw-ring-indigo-200' },
    { id: 5, value: 'day-two-call-two' , name: 'No reply 5', text: 'tw-text-indigo-500', textLight: 'tw-text-indigo-800', bg: 'tw-bg-indigo-400/10', bgLight: 'tw-bg-indigo-100', ring: 'tw-ring-indigo-300' },
    { id: 6, value: 'day-two-call-three' , name: 'No reply 6', text: 'tw-text-indigo-500', textLight: 'tw-text-indigo-900', bg: 'tw-bg-indigo-600/10', bgLight: 'tw-bg-indigo-100', ring: 'tw-ring-indigo-400' },
    { id: 7, value: 'day-three-call-one' , name: 'No reply 7', text: 'tw-text-blue-500', textLight: 'tw-text-blue-700', bg: 'tw-bg-blue-200/10', bgLight: 'tw-bg-blue-100', ring: 'tw-ring-blue-200' },
    { id: 8, value: 'day-three-call-two' , name: 'No reply 8', text: 'tw-text-blue-500', textLight: 'tw-text-blue-800', bg: 'tw-bg-blue-400/10', bgLight: 'tw-bg-blue-100', ring: 'tw-ring-blue-300' },
    { id: 9, value: 'day-three-call-three' , name: 'No reply 9', text: 'tw-text-blue-500', textLight: 'tw-text-blue-900', bg: 'tw-bg-blue-600/10', bgLight: 'tw-bg-blue-100', ring: 'tw-ring-blue-400' },
...
export const confirmationsFollowup = [
    ...
    { id: 10, value: 'reporter' , name: 'Reported', text: 'tw-text-teal-500', textLight: 'tw-text-teal-800', bg: 'tw-bg-teal-500/10', bgLight: 'tw-bg-teal-100', ring: 'tw-ring-teal-300' },
    { id: 11, value: 'annuler' , name: 'Canceled', text: 'tw-text-red-500', textLight: 'tw-text-red-800', bg: 'tw-bg-red-500/10', bgLight: 'tw-bg-red-100', ring: 'tw-ring-red-300' },
    { id: 13, value: 'reconfirmer' , name: 'Reconfirmed', text: 'tw-text-cyan-500', textLight: 'tw-text-cyan-800', bg: 'tw-bg-cyan-500/10', bgLight: 'tw-bg-cyan-100', ring: 'tw-ring-cyan-300' },
]
...
export const deliveryStatus = [
    { id: 0, value: null , name: 'Select', text: 'tw-text-gray-500', textLight: 'tw-text-gray-800', bg: 'tw-bg-gray-500/10', bgLight: 'tw-bg-gray-100', ring: 'tw-ring-gray-300' },
    { id: 1, value:'dispatch', name: 'Dispatched', text: 'tw-text-yellow-500', textLight: 'tw-text-yellow-800', bg: 'tw-bg-yellow-500/10', bgLight: 'tw-bg-yellow-100', ring: 'tw-ring-yellow-300' },
    { id: 2, value: 'expidier' , name: 'Shipped', text: 'tw-text-fuchsia-500', textLight: 'tw-text-fuchsia-800', bg: 'tw-bg-fuchsia-500/10', bgLight: 'tw-bg-fuchsia-100', ring: 'tw-ring-fuchsia-300' },

    { id: 3, value:'livrer', name: 'Delivered', text: 'tw-text-green-500', bg: 'tw-bg-green-500/10', textLight: 'tw-text-green-800', bgLight: 'tw-bg-green-100', ring: 'tw-ring-green-300' },
    { id: 4, value:'reporter', name: 'Reported', text: 'tw-text-orange-500', bg: 'tw-bg-orange-500/10', textLight: 'tw-text-orange-800', bgLight: 'tw-bg-orange-100', ring: 'tw-ring-orange-300' },
