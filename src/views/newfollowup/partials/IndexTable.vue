...
<script>
import TablePaginationNoNums from '@/views/newfollowup/partials/table/TablePaginationNoNums';
import TableRow from '@/views/newfollowup/partials/table/TableRow';
