...
<script>
import IndexStatistics from '@/views/newfollowup/partials/filters/IndexStatistics'
import IndexExport from '@/views/newfollowup/partials/filters/IndexExport'
import FiltersWrapper from '@/views/newfollowup/partials/filters/FiltersWrapper'
