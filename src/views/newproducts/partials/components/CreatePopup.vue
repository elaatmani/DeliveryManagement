...
import OrderItems from '@/views/newproducts/partials/components/OrderItems'
import OrderAffectation from '@/views/newproducts/partials/components/OrderAffectation'
