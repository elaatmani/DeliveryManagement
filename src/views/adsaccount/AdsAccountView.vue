    ...
    <div class="tw-flex tw-items-center tw-justify-between tw-flex-wrap">
        <div>
            <div class="tw-flex tw-items-center tw-gap-x-3">
                <h2 class="tw-text-lg tw-font-medium tw-text-gray-800 darkx:tw-text-white">Ad account</h2>
            ...
            <p class="tw-mt-1 tw-text-sm tw-text-gray-500 darkx:tw-text-gray-300">Account List.</p>
        </div>

        <div v-if="$user.role == 'admin'"  @click="create_popup = true" class="tw-flex tw-items-center tw-mt-4 tw-gap-x-3">
...
import IndexTable from '@/views/adsaccount/partials/IndexTable'
import IndexFilters from '@/views/adsaccount/partials/filters/IndexFilters';
import CreatePopup from '@/views/adsaccount/partials/components/CreatePopup'
...
export default {
  ...
  methods: {
    ...
    paginateOrders() {
      ...
      return Adaccount.paginate(url, options)
      .then(({data}) => {
        const options = data.data.adsaccount;  
