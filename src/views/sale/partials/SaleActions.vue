<template>
  <div v-if="newSale">
    <v-btn link target="_blank" :href="'https://api.whatsapp.com/send?phone=' + sale.phone.replace('+', '')" class="mr-2 !tw-px-0 !tw-py-0" min-height="25px" min-width="30" color="green" variant="flat" density="comfortable" :ripple="false" size="small">
