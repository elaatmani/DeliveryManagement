<template>
  <div v-if="!loading" class="tw-bg-orange-400 tw-text-white tw-p-4 tw-rounded-lg tw-w-full tw-h-full tw-shadow-lg">
    ...
    <div class="tw-mt-8 tw-relative tw-h-6 tw-rounded-full tw-overflow-hidden">
            <div class="tw-bg-white tw-h-full tw-rounded-full tw-relative">
                ...
                <div class="tw-absolute tw-inset-y-0 tw-left-0 tw-flex tw-items-center tw-justify-center tw-text-sm" :style="{width: `${percentage}%`}">
                    {{ currentLeads }}
                </div>
            </div>
