<template>
 <div class="tw-grid tw-grid-cols-1 sm:tw-grid-cols-2 lg:tw-grid-cols-12 tw-gap-4">
    ...
    <div class="tw-col-span-1 sm:tw-col-span-2 lg:tw-col-span-4 tw-bg-white tw-rounded tw-border tw-border-solid tw-border-gray-200">
        <SourceDonutsCharts />
    </div>

    <div class="tw-col-span-1 sm:tw-col-span-2 lg:tw-col-span-8 tw-bg-white tw-rounded tw-border tw-border-solid tw-border-gray-200">
        <CostPerDay/>
    </div>

    <div class="tw-col-span-1 lg:tw-col-span-12 tw-bg-white tw-rounded tw-border tw-border-solid tw-border-gray-200">
        <LeadsChart/>
    </div>
