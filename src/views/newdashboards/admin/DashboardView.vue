...
export default {
    components: { OnlineUsers, IndexStatistics, IndexFilters, IndexRevenue, RealTimeOnlineUsers, RevenueContainer, OrdersByDayChart, ConfirmedByDayChart, DeliveredByDayChart, TurnoverByDayChart },
