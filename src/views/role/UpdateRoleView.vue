<template>
  <div>
    <div class="mb-5">
      ...
      <h2 class="tw-text-gray-500 tw-text-sm">Update existing role</h2>
    </div>
...
export default {
  ...
  methods: {
    ...
    getRole() {
      User.getRole(this.$route.params.id)
      .then(
        res => {
          this.name = res.data.data.role
          this.selectedPermissions = [...res.data.data.permission]
