...
import IndexTable from "@/views/newfollowup/partials/IndexTable";
import IndexFilters from "@/views/newfollowup/partials/filters/IndexFilters";
import { getPath } from "@/helpers/methods";
import CreatePopup from '@/views/newfollowup/partials/components/CreatePopup'
