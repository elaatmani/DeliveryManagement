<template>
  <div>
    ...
    <div v-if="fetched" class="tw-relative">
        ...
        :value="affectation"
        @change="handleChange"
        :disabled="!['confirmer', 'refund', 'change'].includes(item.confirmation)"
        :class="[error && '!tw-border-red-400', !['confirmer', 'refund', 'change'].includes(item.confirmation) && 'tw-cursor-not-allowed']"
