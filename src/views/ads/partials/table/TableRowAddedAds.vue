<template>
    ...
    >
      ...
      <td class="tw-px-4 tw-py-2 tw-text-sm tw-whitespace-nowrap">
        <div>
          <TableActions2 @update=" newItem => $emit('update', newItem)" @delete="id => $emit('delete', id)" :item="item"  @adApproved="$emit('adApproved', $event)"/>
        </div>
      </td>
    </tr>
</template>
...
import TableActions2 from '@/views/ads/partials/table/TableActions2'

export default {
  components: {TableActions2},
