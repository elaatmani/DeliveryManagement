...
<script>
// import IndexStatistics from '@/views/newfactorisation/partials/filters/IndexStatistics'
import FiltersWrapper from '@/views/newfactorisation/partials/filters/FiltersWrapper'
